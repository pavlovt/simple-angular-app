...
export class CoreService {
  ...
  daytz(date, timezone, inFormat = 'YYYY-MM-DD[T]HH:mm:ss') {
    return dayjs.tz(date, inFormat, timezone);
  }

  dayjs(date, inFormat = 'YYYY-MM-DD[T]HH:mm:ss') {
    return dayjs(date, inFormat);
  }

  time(time, inFormat = 'HH:mm') {
    return dayjs(time, inFormat);
  }
